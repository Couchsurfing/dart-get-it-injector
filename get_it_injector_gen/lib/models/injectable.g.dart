...
Injectable _$InjectableFromJson(Map json) => Injectable(
  ...
  implementations:
      (json['implementations'] as List<dynamic>?)
          ?.map(
            (e) => Implementation.fromJson(Map<String, dynamic>.from(e as Map)),
          )
          .toList() ??
      [],
  ...
  group: json['group'] == null ? null : Group.fromJson(json['group'] as Map),
...
Map<String, dynamic> _$InjectableToJson(
  Injectable instance,
) => <String, dynamic>{
  'type': instance.type,
  'import': instance.import,
  'implementations': instance.implementations.map((e) => e.toJson()).toList(),
