...
Settings _$SettingsFromJson(Map json) => Settings.defaults(
  ...
  groups:
      ...
      const {},
  factories:
      (json['factories'] as List<dynamic>?)?.map((e) => e as String).toList() ??
      const [],
  lazySingletons:
      (json['lazy_singletons'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  singletons:
      (json['singletons'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  registerDefault:
      $enumDecodeNullable(_$RegisterTypeEnumMap, json['register_default']) ??
      RegisterType.factory,
  autoRegister: json['auto_register'] as bool? ?? false,
  register:
      (json['register'] as List<dynamic>?)?.map((e) => e as String).toList() ??
      const [],
  doNotRegister:
      (json['do_not_register'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  ignoreForFile:
      (json['ignore_for_file'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
);
